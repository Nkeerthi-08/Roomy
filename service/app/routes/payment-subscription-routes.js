...
const stripe = new stripeImport.Stripe(process.env.STRIPE_SECRET_KEY);
...
PaymentSubscriptionRouter.post('/webhook', async (req, res) => {
  ...
  if (event.type === 'invoice.payment_succeeded') {
    ...
    if (invoice.billing_reason === 'subscription_create') {
      ...
      const result = await PaymentSubscription.create(subscriptionDocument);
      ...
      const result = await PaymentSubscription.updateOne(filter, updateDoc);
