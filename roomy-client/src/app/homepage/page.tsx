    ...
    <div className="relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 gap-8">
          ...
          <div className="bg-[url('/placeholder.svg?height=768&width=1566')] bg-cover bg-no-repeat" />
        </div>
      </div>
      <div className="grid grid-cols-2 gap-8 px-4 sm:px-6 lg:px-8 pb-16 md:pb-24">
        <Card className="bg-[url('/placeholder.svg?height=400&width=800')] bg-cover bg-no-repeat">
          <CardContent className="flex flex-col items-center justify-center bg-white p-6 rounded-md">
