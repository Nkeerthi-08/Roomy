...
import { CreateReportRequest, useCreateReportMutation } from "@/store/services/report-service";
      ...
      <Dialog open={isOpen}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              If you think this property has some issue please report with description
            </DialogDescription>
          </DialogHeader>
